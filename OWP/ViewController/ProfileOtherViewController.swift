...
class ProfileOtherViewController : UIViewController{
    ...
    @IBAction func onTouchTrack(){
        print ("Touched Track Button")
    }
...
extension ProfileOtherViewController: UITableViewDataSource{
...
extension ProfileOtherViewController: UITableViewDelegate{
